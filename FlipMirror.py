...
class FlipMirror:
    def __init__(self, serial_no='37005203'):  # replace with your device's serial number
    ...
    def move(self, command):
        ...
        if command == "on":
            ...
            print("Flip Mirror: Invalid command!")
            return
